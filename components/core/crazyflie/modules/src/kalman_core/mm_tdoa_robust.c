...
void kalmanCoreRobustUpdateWithTDOA(kalmanCoreData_t* this, tdoaMeasurement_t *tdoa)
{
    ...
    if ((d0 != 0.0f) && (d1 != 0.0f)) {
        ...
        static xtensa_matrix_instance_f32 Pc_tran_m = {KC_STATE_DIM, KC_STATE_DIM, (float *)Pc_tran};

        float h[KC_STATE_DIM] = {0};
        xtensa_matrix_instance_f32 H = {1, KC_STATE_DIM, h};    
        // The Kalman gain as a column vector
        static float Kw[KC_STATE_DIM];                           
        static xtensa_matrix_instance_f32 Kwm = {KC_STATE_DIM, 1, (float *)Kw};

        // float error_x[STATE_DIM]={0};          // error state
        // xtensa_matrix_instance_f32 error_x_mat = {STATE_DIM, 1, error_x};
        
        static float e_x[KC_STATE_DIM];
        static xtensa_matrix_instance_f32 e_x_m = {KC_STATE_DIM, 1, e_x};
        
        static float Pc_inv[KC_STATE_DIM][KC_STATE_DIM];
        static xtensa_matrix_instance_f32 Pc_inv_m = {KC_STATE_DIM, KC_STATE_DIM, (float *)Pc_inv};
        
        // rescale matrix
        static float wx_inv[KC_STATE_DIM][KC_STATE_DIM];
        static xtensa_matrix_instance_f32 wx_invm = {KC_STATE_DIM, KC_STATE_DIM, (float *)wx_inv};
        // tmp matrix for P_chol inverse
        static float tmp1[KC_STATE_DIM][KC_STATE_DIM];
        static xtensa_matrix_instance_f32 tmp1m = {KC_STATE_DIM, KC_STATE_DIM, (float *)tmp1};

        static float Pc_w_inv[KC_STATE_DIM][KC_STATE_DIM];
        static xtensa_matrix_instance_f32 Pc_w_invm = {KC_STATE_DIM, KC_STATE_DIM, (float *)Pc_w_inv};

        static float P_w[KC_STATE_DIM][KC_STATE_DIM];
        static xtensa_matrix_instance_f32 P_w_m = {KC_STATE_DIM, KC_STATE_DIM, (float *)P_w};
        ...
        static xtensa_matrix_instance_f32 x_errm = {KC_STATE_DIM, 1, x_err};
