...
//  this->S[KC_STATE_D2] = 0;
  ...
  initialQuaternion[0] = cosf(initialYaw / 2);
  initialQuaternion[1] = 0.0;
  initialQuaternion[2] = 0.0;
  initialQuaternion[3] = sinf(initialYaw / 2);
...
void kalmanCoreScalarUpdate(kalmanCoreData_t* this, xtensa_matrix_instance_f32 *Hm, float error, float stdMeasNoise)
{
